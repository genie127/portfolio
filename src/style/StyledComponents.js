...
background: ${pointColor}; color:#fff; font-size:14px; padding: 5px 10px; border-radius:3px; margin: 5px 2.5px 0; @media(max-width:420px){font-size:3.5vw; padding: 2vw 3vw 1.8vw;}`
